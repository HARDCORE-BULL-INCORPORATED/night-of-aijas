...
export class TacticRoulette {
    ...
    set_tactics = () => {
        ...
        const tactic_actors_len = this.allTactics.length; // number of tactics from DB
        ...
        // create prize tactic
        tactics[this.tacticPrizeId] = {
            ...this.winner,
            id: this.tacticPrizeId,
        };
   ...
   -----------------------------------------------------------------------------*/
    spin = () => {
        ...
        const rouletteContainer = this
            .rouletteWrapperRef as unknown as HTMLElement;
        ...
        const currentItemWidth =
            window.innerWidth <= 768 ? 150 : this.itemWidth;
